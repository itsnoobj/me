...
I explored this in [Your Agents Are Running. So Why Are You Still Exhausted?](/notes/cognitive-load-agentic-ai) — cognitive load isn't just about individual developers. It's about teams. And it's about what happens when you exceed the limit.
...
This connects to something I wrote about in [The Prisoner's Dilemma Is Why You Got Ghosted on Slack](/notes/game-theory-engineering-collaboration). The reason you get ghosted isn't malice — it's that the game doesn't reward responding. A Team API changes the game. It makes responsiveness a *structural* property, not a personal one.
