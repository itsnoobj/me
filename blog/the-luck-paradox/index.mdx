...
That last one — "increase the luck of others" — is the whole game. It's the same principle behind [InnerSource](/notes/why-you-should-never-innersource) (lowering barriers so talent finds opportunity) and behind fixing the payoff matrix (making cooperation the rational choice). The mechanism is different. The goal is the same: **build systems where the best people don't need to be lucky to succeed.**
