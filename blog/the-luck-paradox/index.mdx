...
<div style={{textAlign: 'center'}}>
  <img src={require('./bow.gif').default} alt="Taking a bow" width="400" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('./math-lady.gif').default} alt="Confused math" width="250" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('./cookie.gif').default} alt="Cookie Monster grabbing cookies" width="250" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('./mind-blown.gif').default} alt="Mind blown" width="200" />
</div>
