...
Nobody gets fired for maintaining the status quo. People get fired for approving a tool that causes an incident. The incentive structure rewards inaction — the same [payoff problem that makes cross-team collaboration break down at scale](/notes/why-everyones-busy-but-nothing-ships-faster).
